...
can_frame_lib UUgreenFrameGenerator::init_frame(uint8_t module_address) {
    can_frame_lib frame{};
...
can_frame_lib UUgreenFrameGenerator::create_command_frame(uint8_t module_address, uint8_t prefix, uint8_t command) {
...
can_frame_lib UUgreenFrameGenerator::create_control_frame(uint8_t module_address, uint8_t command, uint8_t value) {
    can_frame_lib frame = create_command_frame(module_address, UUgreenConstants::CONTROL_PREFIX, command);
    frame.data[7] = value;
    return frame;
}
...
can_frame_lib UUgreenFrameGenerator::generateTempRequest(uint8_t module_address) {
    return create_command_frame(module_address, UUgreenConstants::PREAMBLE, UUgreenConstants::TEMP_CMD);
}

can_frame_lib UUgreenFrameGenerator::generateCurrentCapabilityRequest(uint8_t module_address) {
    return create_command_frame(module_address, UUgreenConstants::PREAMBLE, UUgreenConstants::CURRENT_CAP_CMD);
}

can_frame_lib UUgreenFrameGenerator::generateFlagsRequest(uint8_t module_address) {
    return create_command_frame(module_address, UUgreenConstants::PREAMBLE, UUgreenConstants::FLAGS_CMD);
}

can_frame_lib UUgreenFrameGenerator::generateVoltageRequest(uint8_t module_address) {
    return create_command_frame(module_address, UUgreenConstants::PREAMBLE, UUgreenConstants::VOLTAGE_CMD);
}

can_frame_lib UUgreenFrameGenerator::generateCurrentRequest(uint8_t module_address) {
    return create_command_frame(module_address, UUgreenConstants::PREAMBLE, UUgreenConstants::CURRENT_CMD);
}

can_frame_lib UUgreenFrameGenerator::generateLowModeSet(uint8_t module_address) {
    return create_control_frame(module_address, UUgreenConstants::MODE_SET_CMD, UUgreenConstants::LOW_MODE);
}

can_frame_lib UUgreenFrameGenerator::generateHighModeSet(uint8_t module_address) {
    return create_control_frame(module_address, UUgreenConstants::MODE_SET_CMD, UUgreenConstants::HIGH_MODE);
}

std::optional<can_frame_lib> UUgreenFrameGenerator::generateAutoModeSet(uint8_t module_address) {
    (void)module_address;
    return std::nullopt;
}

can_frame_lib UUgreenFrameGenerator::generateVoltageSet(uint8_t module_address, float voltage) {
...
can_frame_lib UUgreenFrameGenerator::generateCurrentSet(uint8_t module_address, float current) {
...
can_frame_lib UUgreenFrameGenerator::generateEnable(uint8_t module_address) {
    return create_control_frame(module_address, UUgreenConstants::POWER_CTRL_CMD, UUgreenConstants::ON);
}

can_frame_lib UUgreenFrameGenerator::generateDisable(uint8_t module_address) {
